...
xst -ifn xst.scr
move clkwiz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkwiz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkwiz_exdes.ucf clkwiz_exdes

echo 'Running map'
map -timing -pr b clkwiz_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clkwiz_exdes -w routed.ncd routed.v
cd ..
