...
vlog -work work clkwiz_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax clkwiz_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.clkwiz_tb work.glbl
